...
<Link id="RouterLink" to="/"> <li>place</li></Link>
    </ul>
</div>
...
<div className="imhed" style={{width:"100%", position:"relative",position:"relative",top:"-110px"}}><h1 className="hhed">MAKE<br></br> YOUR SELF<br/> AT HOME</h1> <img className="imhed1" src={im34} alt="im " style={{width:"100%"}}/> </div>
...
<div className="bs bhot"><button className="b1 bhot1" type="submit">Book your place</button>
...
<h1 className="discoverh1">DISCOVER
EXPERIENCE
</h1>

<div className="discover">
   
    <div><img src={im35} alt="im"/> <h4>Nice welcom</h4> </div>
    <div><img src={im36} alt="im"/> <h4> Art Break</h4> </div>
    <div><img src={im42} alt="im"/> <h4>Day Spa</h4> </div>
...
<img src={im25} alt="im" className="cover-servse">
...
<div className="imgs"><img src={im18} alt="im"></img><h4>WE CLEAN EVERYDAY</h4>
...
<div className="imgs"><img src={im19} alt="im"></img><h4>FREE BREAKFAST</h4>
Morbi leo risus, porta ac consectetur ac,
 vesti bulum at eros. Fusce dapibus,
  tellus ac cursus commodo, 
  tortor mauris condimentum.</div>
...
<div className="imgs"><img src={im17} alt="im"></img><h4>ENJOY NIGHTLIFE</h4>
Morbi leo risus, porta ac consectetur ac, 
vesti bulum at eros. Fusce dapibus, 
tellus ac cursus commodo,
 tortor mauris condimentum.</div>
...
<div className="imgs"><img src={im16} alt="im"></img><h4>FREE BREAKFAST</h4>
Morbi leo risus,
...
<div className="imgs"><img src={im15} alt="im"></img><h4>MIDDLE OF DOWNTOWN</h4>
Morbi leo risus, porta ac consectetur ac,
 vesti bulum at eros.
  Fusce dapibus,
   tellus ac cursus commodo, 
  ...
  <div className="imgs"><img src={im26} alt="im"></img><h4>MEET NEW PEOPLE</h4>
Morbi leo risus, porta ac consectetur ac,
 vesti bulum at eros.
  Fusce dapibus,
   tellus ac cursus commodo, 
